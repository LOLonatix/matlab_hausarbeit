...
%    %nun cash-based adjustments ausrechnen
   ...
   cACbOpProfit_CurrentCompany=cell2mat(cAGrossProfit(i))+cACashBasedAdj./rCurrentCompany.TOTAL_ASSETS; %hier nochmal checken!
   
end
[dMeanCbOpProfit,dSDCbOpProfit,d1stQCbOpProfit,d25stQCbOpProfit,d50stQCbOpProfit,d75stQCbOpProfit,d99stQCbOpProfit] = fConclude(cAGrowthTA);
end